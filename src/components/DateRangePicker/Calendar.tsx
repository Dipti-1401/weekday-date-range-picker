  ...
  function renderDays() {
    ...
    for (let i = 1; i <= numberOfDays; i++) {
      ...
      days.push(
        <div
          key={i}
          className={`${styles.day} ${isWeekend(date) ? styles.weekend : ''} ${isCurrentDaySelected ? styles.selected : ''}`}
  ...
  return (
    <div className={styles.calendar}>
      <div className={styles.calendarHeader}>
        <button onClick={() => onMonthYearChange(currentMonth - 1, currentYear)}>&lt;</button>
